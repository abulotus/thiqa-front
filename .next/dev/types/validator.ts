...
// Validate ../../../src/app/(admin)/(others-pages)/credit-accounts/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/credit-accounts">> = Specific
  const handler = {} as typeof import("../../../src/app/(admin)/(others-pages)/credit-accounts/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../src/app/(admin)/(others-pages)/customers/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/customers">> = Specific
  const handler = {} as typeof import("../../../src/app/(admin)/(others-pages)/customers/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../../src/app/(admin)/(others-pages)/merchants/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/merchants">> = Specific
  const handler = {} as typeof import("../../../src/app/(admin)/(others-pages)/merchants/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
